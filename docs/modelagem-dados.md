...
- A definição física está versionada em [V1__create_initial_schema.sql](/Users/levilunique/Workspace/Java/FIAP/TechChallenge/challenge1/restaurant-user-api/src/main/resources/db/migration/V1__create_initial_schema.sql).
